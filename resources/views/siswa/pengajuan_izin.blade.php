...
<head>
    ...
    <title>Pengajuan Surat Izin/Sakit - Sistem Absensi QR</title>
    ...
    <div class="flex">
        ...
        <div class="w-64 bg-white shadow-md min-h-screen">
            <div class="p-6">
                ...
                <nav class="space-y-2">
                    <a href="{{ route('siswa.absensi') }}" class="block px-4 py-3 rounded-lg text-gray-700 hover:bg-gray-100 transition">
                        <i class="fas fa-qrcode mr-3"></i>Scan QR
                    </a>
                    <a href="{{ route('siswa.pengajuan_izin') }}" class="block px-4 py-3 rounded-lg bg-blue-500 text-white transition">
                        <i class="fas fa-file-medical mr-3"></i>Pengajuan Izin
                    </a>
                    <a href="{{ route('siswa.riwayat') }}" class="block px-4 py-3 rounded-lg text-gray-700 hover:bg-gray-100 transition">
